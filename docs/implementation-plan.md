...
7. **M07 — Standardize Python 3.14 docs/local**
...
8. **M08 — Dockerize backend with uv**
...
9. **M09 — Align compose/deploy artifacts**
...
10. **M10 — Enforce uv-only packaging**
...
13. **M13 — TypeScript strict checks**
...
14. **M14 — Frontend hooks in pre-commit**
...
15. **M15 — Core math scope extraction**
...
23. **M23 — Backend layer decomposition**
...
25. **M25 — Frontend architecture refactor**
...
27. **M27 — Governance files**
    - Objective: Establish contributor process and security policy baseline for OSS collaboration.
    - Exact files/areas impacted (paths): `./CONTRIBUTING.md`, `./SECURITY.md`, `./README.md`.
    - Exact commands to run/verify locally:
      ```bash
      test -f ./CONTRIBUTING.md && test -f ./SECURITY.md
      ```
    - Done criteria: governance docs exist and are linked from top-level documentation.
    - Risk/notes: Low.

28. **M28 — Issue and PR templates**
    - Objective: Standardize issue intake and pull-request quality checklist.
    - Exact files/areas impacted (paths): `./.github/ISSUE_TEMPLATE/`, `./.github/pull_request_template.md`.
    - Exact commands to run/verify locally:
      ```bash
      test -f ./.github/pull_request_template.md
      ```
    - Done criteria: bug/feature issue templates and PR template are present and usable.
    - Risk/notes: Low.

29. **M29 — Citation and release automation**
    - Objective: Provide citable metadata and automate release workflow entrypoint.
    - Exact files/areas impacted (paths): `./CITATION.cff`, `./.github/workflows/release.yml.disabled`, `./docs/releases.md`, `./README.md`, `./docs/index.md`.
    - Exact commands to run/verify locally:
      ```bash
      uvx cffconvert --validate -i CITATION.cff
      ```
    - Done criteria: citation metadata validates and release workflow/docs are connected.
    - Risk/notes: Medium.

30. **M30 — Security and dependency scans**
    - Objective: Add repeatable secret and dependency scanning in repository policy and CI templates.
    - Exact files/areas impacted (paths): `./.github/workflows/security.yml.disabled`, `./.github/dependabot.yml`, `./gitleaks.toml`, `./README.md`, `./docs/tooling-matrix.md`.
    - Exact commands to run/verify locally:
      ```bash
      gitleaks detect --source . --config gitleaks.toml --redact --no-banner
      ```
    - Done criteria: scanning configs exist and are documented in project tooling references.
    - Risk/notes: Medium.

31. **M31 — Release readiness dry run**
    - Objective: Capture final readiness checklist and dry-run evidence before public publication.
    - Exact files/areas impacted (paths): `./docs/release-checklist.md`, `./docs/index.md`, `./.github/workflows/`.
    - Exact commands to run/verify locally:
      ```bash
      rg -n "release checklist" docs/release-checklist.md
      ```
    - Done criteria: release checklist exists, is indexed in docs, and includes a dry-run record.
    - Risk/notes: Medium.
...
33. **M33 — Expand frontend coverage scope**
...
34. **M34 — Tighten backend quality scope**
...
35. **M35 — Remove backend deprecations**
...
36. **M36 — Enable public CI workflows**
...
37. **M37 — Finalize public metadata placeholders**
...
38. **M38 — Clean internal tracked artifacts**
