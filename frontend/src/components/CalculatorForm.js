      ...
      {renderCollapsibleSection(
        ...
        <>
          ...
          <div className="text-xs text-gray-500 mb-4 p-2 bg-amber-50 rounded flex items-center">
            <svg
              className="w-4 h-4 mr-1.5 text-amber-400 flex-shrink-0"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            Set TTFT and Latency targets below to validate your configuration against SLA
            requirements.
          </div>
          {renderSliderInput(
            "ttft_sla",
            ...
            formData.ttft_sla || 0,
            "sec",
            "Maximum acceptable Time To First Token (seconds). Leave at 0 to skip this check.",
          )}
          {renderSliderInput(
            "e2e_latency_sla",
            ...
            300,
            1,
            formData.e2e_latency_sla || 0,
            "sec",
            "Maximum acceptable end-to-end latency (seconds). Leave at 0 to skip this check.",
          )}
        </>,
