  ...
  return (
    <div className="gap-5 flex flex-col flex-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4" data-tour="result-cards">
        {/* Card 1 — Infrastructure (servers + total GPUs) — primary accent */}
        <div className="result-tile bg-accent text-accent-fg rounded-xl p-4 sm:p-6 shadow-card-hover flex flex-col sm:min-h-[170px] overflow-hidden">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 mt-auto mb-auto">
            <div className="text-center">
              <p
                className="text-3xl sm:text-4xl font-semibold tracking-tight leading-none tabular-nums whitespace-nowrap"
                title={String(results.servers_final || 0)}
              >
                {fmt(results.servers_final, 0)}
              </p>
              <p className="text-[10px] sm:text-xs opacity-80 mt-1.5 uppercase tracking-wide">
                {t("results.infrastructure.servers")}
              </p>
            </div>
            <span className="text-2xl opacity-40 leading-none -mt-3" aria-hidden="true">
              ·
            </span>
            <div className="text-center">
              <p
          ...
          <p className="text-xs sm:text-sm opacity-80 mt-2 tabular-nums">
